...
const Order = ({ product, onPay, onPayChange }) => {
            ...
            <div className="col-lg-5">
              <div className="your-order-area">
                ...
                <div className="your-order-wrap gray-bg-4">
                  <div className="your-order-product-info">
                    ...
                    <div className="your-order-middle">
                      <ul>
                        <li>
                          <span className="order-middle-left">{title} X 1</span>{' '}
                          <span className="order-price">{discount}</span>
                        </li>
                      </ul>
                    </div>
                ...
                <div className="place-order mt-25">
                  <button className="btn-hover" onClick={onPay}>
                    결제하기
                  </button>
                </div>
              </div>
